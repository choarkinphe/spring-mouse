 ...
 * If Spring Mouse's Anthropic→OpenAI conversion passes the input as a pre-parsed object,
 ...
 *   3. Forward to Spring Mouse /v1/chat/completions (OpenAI SSE)
