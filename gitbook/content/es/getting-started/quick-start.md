...
Pon en marcha Spring Mouse en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
🎉 **El dashboard se abre automáticamente** en `http://localhost:8008`
...
Apunta tu herramienta de codificación a Spring Mouse:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de spring-mouse]
