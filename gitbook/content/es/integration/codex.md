...
Integra Spring Mouse con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de Spring Mouse.
...
Spring Mouse proporciona los siguientes modelos de Codex:
...
```json
{
  ...
  "apiKey": "your-spring-mouse-api-key",
...
1. Verifica que tu API key sea correcta en el dashboard de Spring Mouse
...
1. Verifica que el nombre del modelo coincida con tu configuración de Spring Mouse
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de Spring Mouse
...
```bash
export OPENAI_BASE_URL="https://spring-mouse.com"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de Spring Mouse.
