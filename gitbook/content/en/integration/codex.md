...
Integrate Spring Mouse with OpenAI Codex CLI to route your OpenAI API requests through Spring Mouse's intelligent routing system.
...
Spring Mouse provides the following Codex models:
...
1. Verify your API key is correct in Spring Mouse dashboard
...
1. Verify the model name matches your Spring Mouse configuration
2. Check that the OpenAI provider connection is active in Spring Mouse dashboard
...
Make sure you have configured your API key in the Spring Mouse cloud dashboard.
