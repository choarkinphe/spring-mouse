<div align="center">
  <img src="../images/spring-mouse.png?1" alt="Panel de control de Spring Mouse" width="800"/>
  
  # Spring Mouse - Enrutador de IA GRATUITO y ahorrador de tokens
  ...
  **Conecta todas tus herramientas de código con IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) a más de 40 proveedores de IA y más de 100 modelos.**
  ...
  [![npm](https://img.shields.io/npm/v/spring-mouse.svg)](https://www.npmjs.com/package/spring-mouse)
  [![Downloads](https://img.shields.io/npm/dm/spring-mouse.svg)](https://www.npmjs.com/package/spring-mouse)
  [![Docker Pulls](https://img.shields.io/docker/pulls/decolua/spring-mouse.svg?logo=docker&label=Docker%20pulls)](https://hub.docker.com/r/decolua/spring-mouse)
  [![GHCR](https://img.shields.io/badge/GHCR-decolua%2Fspring-mouse-blue?logo=github)](https://github.com/decolua/spring-mouse/pkgs/container/spring-mouse)
  [![License](https://img.shields.io/npm/l/spring-mouse.svg)](https://github.com/decolua/spring-mouse/blob/main/LICENSE)

<a href="https://trendshift.io/repositories/22628" target="_blank"><img src="https://trendshift.io/api/badge/repositories/22628" alt="decolua%2Fspring-mouse | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

[🚀 Inicio rápido](#-inicio-rápido) • [💡 Características](#-características-principales) • [📖 Configuración](#-guía-de-instalación) • [🌐 Sitio web](https://spring-mouse.com)
...
🎉 El panel de control se abre en `http://localhost:8008`
...
El paquete de este repositorio es privado (`spring-mouse-app`), por lo que ejecutar desde el código fuente/Docker es la ruta de desarrollo local prevista.

```bash
cp .env.example .env
npm install
PORT=8008 NEXT_PUBLIC_BASE_URL=http://localhost:8008 npm run dev
```
...
```bash
npm run build
PORT=8008 HOSTNAME=0.0.0.0 NEXT_PUBLIC_BASE_URL=http://localhost:8008 npm run start
```

URLs por defecto:

- Panel de control: `http://localhost:8008/dashboard`
- API compatible con OpenAI: `http://localhost:8008/v1`
...
<table>
  ...
  <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
    <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với Spring Mouse" width="300"/>
  </a><br/>
  <b>🇻🇳 Tiếng Việt</b><br/>
  <sub>Tiết kiệm chi phí LLM cho OpenClaw với Spring Mouse<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
</td>
<td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="Spring Mouse + Claude Code FREE Unlimited Setup" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>Spring Mouse + Claude Code FREE Unlimited Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="Spring Mouse Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>Spring Mouse + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="Spring Mouse Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>Spring Mouse + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    ...
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with Spring Mouse 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
  ...
  <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + Spring Mouse<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup Spring Mouse 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy Spring Mouse di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy Spring Mouse di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
...
> 🎬 **¿Has hecho un video sobre Spring Mouse?** Envía una [Pull Request](https://github.com/decolua/spring-mouse/pulls) añadiendo tu video a esta sección — ¡lo fusionaremos!

---

## 🛠️ Herramientas CLI compatibles

Spring Mouse funciona a la perfección con todas las principales herramientas de código con IA:
...
Headroom es opcional y se ejecuta por separado. Spring Mouse llama al endpoint local `/v1/compress` de Headroom y luego mantiene el enrutamiento, la reserva, la autenticación y el seguimiento de uso normales:

```
Client → Spring Mouse → Headroom /v1/compress → Spring Mouse → provider
```
...
Si Headroom está caído o devuelve un error, Spring Mouse falla de forma segura y envía la solicitud original.
...
- Tu herramienta CLI envía el formato OpenAI → Spring Mouse lo traduce → El proveedor recibe el formato nativo
...
> Spring Mouse por sí mismo **nunca te cobra** nada. Solo pagas a los proveedores directamente (si usas servicios de pago).
>
...
> enrutar a través de Spring Mouse!
...
### 📊 Cómo entender los costes y la facturación de Spring Mouse

**Realidad de la facturación de Spring Mouse:**

✅ **El software de Spring Mouse = GRATUITO para siempre** (código abierto, nunca cobra)  
...
❌ **Spring Mouse nunca envía facturas** ni carga tu tarjeta
...
- **Proveedores económicos** (GLM, MiniMax): Págales directamente, Spring Mouse solo enruta
- **Proveedores GRATUITOS** (iFlow, Kiro, Qwen): Realmente gratuitos para siempre, sin cargos ocultos
- **Spring Mouse**: Nunca cobra nada, jamás
...
El panel realiza el seguimiento de tu uso de tokens y muestra **costes estimados** como si estuvieras usando APIs de pago directamente. Esto **no es facturación real** — es una referencia para mostrar cuánto estás ahorrando al usar modelos gratuitos o suscripciones existentes a través de Spring Mouse.
...
<details>
<summary><b>💳 ¿Spring Mouse me cobrará algo?</b></summary>

**No.** Spring Mouse es un software gratuito y de código abierto que se ejecuta en tu propio ordenador. Nunca te cobra nada.

**Solo pagas:**

- ✅ **Proveedores de suscripción** (Claude Code $20/mes, Codex $20-200/mes) → Págales directamente en sus sitios web
- ✅ **Proveedores económicos** (GLM, MiniMax) → Págales directamente, Spring Mouse solo enruta tus solicitudes
- ❌ **El propio Spring Mouse** → **Nunca cobra nada, jamás**

Spring Mouse es un proxy/enrutador local. No tiene tu tarjeta de crédito, no puede enviar facturas y no tiene sistema de facturación. Es software totalmente gratuito.
...
Spring Mouse solo enruta tus solicitudes hacia ellos — no hay "trampa" ni facturación futura. Son servicios realmente gratuitos y Spring Mouse los hace fáciles de usar con soporte de reserva.
...
3. **Usa los proveedores de suscripción al final:**
   ...
   - Spring Mouse te ayuda a maximizar su valor mediante el seguimiento de cuota
...
La reserva inteligente de Spring Mouse evita cargos sorpresa:
...
**Tú tienes el control:** Establece límites de gasto por proveedor en el panel y Spring Mouse los respeta.
...
**Consejo profesional:** Usa Opus para tareas complejas y Sonnet para velocidad. ¡Spring Mouse realiza el seguimiento de la cuota por modelo!
...
Settings → Models → Advanced:
  OpenAI API Base URL: http://localhost:8008/v1
  OpenAI API Key: [desde el panel de spring-mouse]
...
```json
{
  ...
  "anthropic_api_key": "tu-clave-api-de-spring-mouse"
}
```
...
```bash
export OPENAI_BASE_URL="http://localhost:8008"
export OPENAI_API_KEY="tu-clave-api-de-spring-mouse"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "spring-mouse/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Nota:** OpenClaw solo funciona con Spring Mouse local. Usa `127.0.0.1` en lugar de `localhost` para evitar problemas de resolución IPv6.
...
export DATA_DIR="/var/lib/spring-mouse"
export PORT="8008"
export HOSTNAME="0.0.0.0"
export NODE_ENV="production"
export NEXT_PUBLIC_BASE_URL="http://localhost:8008"
export NEXT_PUBLIC_CLOUD_URL="https://spring-mouse.com"
...
# O usa PM2
npm install -g pm2
pm2 start npm --name spring-mouse -- start
pm2 save
pm2 startup
```
...
- Docker Hub: [`decolua/spring-mouse`](https://hub.docker.com/r/decolua/spring-mouse)
- GHCR: [`ghcr.io/decolua/spring-mouse`](https://github.com/decolua/spring-mouse/pkgs/container/spring-mouse)
...
docker run -d \
  --name spring-mouse \
  -p 8008:8008 \
  -v "$HOME/.spring-mouse:/app/data" \
  -e DATA_DIR=/app/data \
  decolua/spring-mouse:latest
```

→ Abre http://localhost:8008
...
git clone https://github.com/decolua/spring-mouse.git
cd spring-mouse/app
docker build -t spring-mouse .
docker run -d --name spring-mouse -p 8008:8008 \
  -v "$HOME/.spring-mouse:/app/data" -e DATA_DIR=/app/data spring-mouse
```
...
docker restart spring-mouse
docker stop spring-mouse && docker rm spring-mouse
docker pull decolua/spring-mouse:latest   # actualiza a la última versión
```

**Persistencia de datos:** `$HOME/.spring-mouse/db/data.sqlite` en el host ↔ `/app/data/db/data.sqlite` en el contenedor.

### Variables de entorno

| Variable                                             | Por defecto                                | Descripción                                                                          |
| ---------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------ |
| `JWT_SECRET`                                         | Generado automáticamente (`~/.spring-mouse/jwt-secret`) | Secreto de firma JWT para la cookie de autenticación del panel (sobreescríbelo para compartir entre instancias) |
| `INITIAL_PASSWORD`                                   | `123456`                                   | Contraseña del primer inicio de sesión cuando no existe un hash guardado             |
| `DATA_DIR`                                           | `~/.spring-mouse`                               | Ubicación principal de datos de la app (SQLite en `$DATA_DIR/db/data.sqlite`)        |
| `PORT`                                               | por defecto del framework                  | Puerto del servicio (`8008` en los ejemplos)                                        |
...
| `BASE_URL`                                           | `http://localhost:8008`                   | URL base interna del lado del servidor usada por los trabajos de sincronización en la nube |
| `CLOUD_URL`                                          | `https://spring-mouse.com`                      | URL base del endpoint de sincronización en la nube del lado del servidor             |
...
| `NEXT_PUBLIC_CLOUD_URL`                              | `https://spring-mouse.com`                      | URL de nube pública/compatible (prefiere `CLOUD_URL` para el runtime del servidor)   |
...
| `ENABLE_REQUEST_LOG_FILE_DUMPS`                                | `false`                                    | Habilita los registros de solicitudes/respuestas en `logs/`                          |
...
- Registros opcionales de solicitudes/translator: `<repo>/logs/...` cuando `ENABLE_REQUEST_LOG_FILE_DUMPS=true`
- Tanto `${DATA_DIR}` como `~/.spring-mouse` resuelven a la misma ubicación en un contenedor de Docker — el enlace simbólico `/root/.spring-mouse -> /app/data` se crea en tiempo de compilación.
...
- Spring Mouse lo renueva automáticamente
...
- Establece `PORT=8008` y `NEXT_PUBLIC_BASE_URL=http://localhost:8008`
...
- Establece `ENABLE_REQUEST_LOG_FILE_DUMPS=true`
...
- **Problemas**: [github.com/decolua/spring-mouse/issues](https://github.com/decolua/spring-mouse/issues)

---

## 👥 Colaboradores

¡Gracias a todos los colaboradores que ayudaron a mejorar Spring Mouse!

[![Contributors](https://contrib.rocks/image?repo=decolua/spring-mouse&max=150&columns=15&anon=1&v=20260309)](https://github.com/decolua/spring-mouse/graphs/contributors)

---

## 📊 Gráfico de estrellas

[![Star Chart](https://starchart.cc/decolua/spring-mouse.svg?variant=adaptive)](https://starchart.cc/decolua/spring-mouse)
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — ahorrador de tokens en Rust. Spring Mouse porta su pipeline de compresión a JS → **−20-40% de tokens de entrada** en cada solicitud.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. Spring Mouse adapta su prompt → **−65% de tokens de salida**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — habilidad del _"dev sénior perezoso"_. Spring Mouse inyecta su jerarquía primero-YAGNI → **menos tokens, menos código, diffs más cortos**.

Un enorme agradecimiento a estos autores — sin su trabajo, las funciones de ahorro de tokens de Spring Mouse no existirían. ¡Dales una ⭐ en GitHub!
...
Spring Mouse was inspired by [9Router](https://github.com/decolua/9router), an AI routing and token-saving gateway. We thank the 9Router project and its contributors for the original architecture and product ideas that helped shape this project.
