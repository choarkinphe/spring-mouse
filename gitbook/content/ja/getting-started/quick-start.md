...
Spring Mouseを5分で起動し、AIリクエストをインテリジェントにルーティングし始めましょう。
...
🎉 **ダッシュボードが自動的に開きます** (`http://localhost:8008`)
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [spring-mouseダッシュボードから取得]
