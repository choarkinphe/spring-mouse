...
Khởi chạy Spring Mouse trong 5 phút và bắt đầu định tuyến các request AI một cách thông minh.
...
🎉 **Dashboard tự động mở** tại `http://localhost:8008`
...
Trỏ công cụ code của bạn tới Spring Mouse:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from spring-mouse dashboard]
