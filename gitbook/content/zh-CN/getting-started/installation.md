...
- ✅ 任意目录均可运行
- ✅ 命令简单:`spring-mouse`
- ✅ 通过 `npm update -g spring-mouse` 自动更新
...
**发生了什么:**
1. 服务器启动在 `http://localhost:8008`
2. 仪表盘在浏览器中自动打开
3. 数据目录创建在 `~/.spring-mouse`
4. API key 自动生成
