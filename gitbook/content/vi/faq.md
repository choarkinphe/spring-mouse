...
Những câu hỏi phổ biến về Spring Mouse.

---

## Spring Mouse là gì?

**Spring Mouse là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**Spring Mouse dùng chiến lược pricing 3 tầng:**
...
## Spring Mouse có miễn phí không?

**Có, Spring Mouse hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của Spring Mouse.**
...
**Spring Mouse theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host Spring Mouse không?

**Có! Spring Mouse hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.spring-mouse`)
...
**Có, Spring Mouse ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.spring-mouse` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server Spring Mouse
...
## Làm thế nào để cập nhật Spring Mouse?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/decolua/spring-mouse/blob/main/CHANGELOG.md)
- Backup `~/.spring-mouse` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/decolua/spring-mouse/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [spring-mouse.com/docs](https://spring-mouse.com/docs)
