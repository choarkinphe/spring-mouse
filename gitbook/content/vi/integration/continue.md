...
Tích hợp Spring Mouse với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- Spring Mouse API key từ [dashboard](https://spring-mouse.com/dashboard)
- Spring Mouse đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model Spring Mouse
...
3. Chọn model Spring Mouse ưa thích
...
- Kiểm tra Spring Mouse đang chạy: `curl http://localhost:8008/health`
...
- Kiểm tra độ trễ network đến Spring Mouse
