...
function AddCompatibleModal({ variant, isOpen, onClose, onCreated, nested = false }) {
  ...
  return (
    <Drawer isOpen={isOpen} title={config.title} onClose={handleClose} width="lg" lockScroll={!nested}>
