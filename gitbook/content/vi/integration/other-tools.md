...
Spring Mouse tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

Spring Mouse cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến Spring Mouse bằng các cài đặt sau:

**Spring Mouse cục bộ:**
```
Base URL: http://localhost:8008/v1
API Key: your-api-key-from-dashboard
Model: any Spring Mouse model (cc/*, cx/*, glm/*, etc.)
```
...
**Vấn đề:** Không kết nối được đến Spring Mouse
```bash
...
**Giải pháp:**
- Xác minh Spring Mouse đang chạy
- Kiểm tra port 8008 không bị chặn
...
- Kiểm tra model có sẵn: `curl http://localhost:8008/v1/models`
...
- Kiểm tra kết nối network đến Spring Mouse
