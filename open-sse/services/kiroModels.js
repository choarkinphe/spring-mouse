 ...
 * into spring-mouse-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are spring-mouse fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic spring-mouse variant set for a single upstream Kiro model.
 *
 ...
 * into spring-mouse variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
