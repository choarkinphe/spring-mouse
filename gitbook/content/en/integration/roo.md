...
Integrate Spring Mouse with Roo AI Assistant to access multiple AI models through a unified interface.
...
Choose from available Spring Mouse models:
...
### Connection Failed
- Verify Spring Mouse is running: `curl http://localhost:8008/health`
- Check API key is correct
- Ensure Base URL includes `/v1` suffix

### Model Not Available
- Check model name matches exactly (case-sensitive)
- Verify model is enabled in your Spring Mouse plan
- Try a different model from the list

### Slow Responses
- Switch to faster models (haiku, flash)
- Check network connection
- Monitor Spring Mouse logs for issues
