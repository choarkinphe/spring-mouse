...
Tích hợp Spring Mouse với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của Spring Mouse.
...
Spring Mouse cung cấp các model Codex sau:
...
1. Xác minh API key đúng trong Spring Mouse dashboard
...
1. Xác minh tên model khớp với cấu hình Spring Mouse
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong Spring Mouse dashboard
...
Đảm bảo bạn đã cấu hình API key trong Spring Mouse cloud dashboard.
