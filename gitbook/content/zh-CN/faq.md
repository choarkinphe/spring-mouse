...
关于 Spring Mouse 的常见问题。

---

## 什么是 Spring Mouse?

**Spring Mouse 是一款 AI 模型路由工具,能够最大化你的订阅价值并最小化成本。**
...
## 可以自托管 Spring Mouse 吗?

**可以!Spring Mouse 支持多种部署方式:**
...
**环境变量:**
- `JWT_SECRET` - **生产环境必须修改!**
- `DATA_DIR` - 数据库存储路径(默认:`~/.spring-mouse`)
...
**是的,Spring Mouse 优先考虑安全和隐私:**

**本地存储:**
- 所有数据存储在本地 `~/.spring-mouse`(或自定义 `DATA_DIR`)
- 不会发送数据到 Spring Mouse 服务器
...
**破坏性变更:**
- 查看 [CHANGELOG.md](https://github.com/decolua/spring-mouse/blob/main/CHANGELOG.md)
- 大版本更新前备份 `~/.spring-mouse`
- 阅读大版本的迁移指南
...
详情见 [CONTRIBUTING.md](https://github.com/decolua/spring-mouse/blob/main/CONTRIBUTING.md)。

---

## 需要更多帮助?

- **文档:** [spring-mouse.com/docs](https://spring-mouse.com/docs)
