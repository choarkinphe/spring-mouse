...
Integrate Spring Mouse with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- Spring Mouse API key from [dashboard](https://spring-mouse.com/dashboard)
- Spring Mouse running (local or cloud)
...
### 2. Add Spring Mouse Model Configuration
...
3. Choose your preferred Spring Mouse model
...
- Check network latency to Spring Mouse
