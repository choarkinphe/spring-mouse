...
5 分钟启动 Spring Mouse,开始智能路由 AI 请求。
...
🎉 **仪表盘自动打开** 地址为 `http://localhost:8008`
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [从 spring-mouse 仪表盘获取]
...
- **网站**: [spring-mouse.com](https://spring-mouse.com)
