...
Integra Spring Mouse con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de Spring Mouse.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- Spring Mouse ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de Spring Mouse:

**Para Spring Mouse local:**
```
http://localhost:8008/v1
```

**Para Spring Mouse en la nube:**
```
https://spring-mouse.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de Spring Mouse
...
3. La key debe comenzar con `sk-spring-mouse-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de Spring Mouse
...
4. Cline usará Spring Mouse para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando Spring Mouse
...
3. Obtén explicaciones potenciadas por IA a través de Spring Mouse

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará Spring Mouse para entender el contexto y hacer cambios
...
1. Verifica que Spring Mouse esté corriendo: `curl http://localhost:8008/health`
2. Verifica que la URL base sea correcta e incluya `/v1`
3. Asegúrate de que ningún firewall esté bloqueando el puerto 8008
...
2. Verifica que tu instancia de Spring Mouse esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de Spring Mouse para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de Spring Mouse en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://spring-mouse.com`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de Spring Mouse
...
## Integración con características de Spring Mouse

### Enrutamiento de modelos

Spring Mouse enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, Spring Mouse automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de Spring Mouse:
