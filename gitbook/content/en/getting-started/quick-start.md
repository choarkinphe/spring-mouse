...
Get Spring Mouse running in 5 minutes and start routing AI requests intelligently.
...
🎉 **Dashboard opens automatically** at `http://localhost:8008`
...
Point your coding tool to Spring Mouse:
