...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/service/spring-mouse/refs/heads/master/CHANGELOG.md",
  donateUrl: "",
};

// Updater configuration
// NOTE: Spring Mouse is an internal fork — releases go through git + Jenkins,
// never the npm registry. /api/version no longer queries npm (hasUpdate is
// always false), so these npm updater fields are effectively dormant and kept
// only for shape compatibility.
export const UPDATER_CONFIG = {
  npmPackageName: "spring-mouse",
  installCmd: "npm i -g spring-mouse",
  installCmdLatest: "npm i -g spring-mouse@latest --prefer-online",
...
export const THEME_CONFIG = {
  // New key intentionally resets the previous system/light preference so the
  // dashboard consistently opens in the global dark palette.
  storageKey: "spring-mouse-theme-v2",
