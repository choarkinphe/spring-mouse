...
Integrate Spring Mouse with Claude Code CLI to route your Anthropic API requests through Spring Mouse's intelligent routing system.
...
Claude Code supports the following model aliases that map to Spring Mouse models:
