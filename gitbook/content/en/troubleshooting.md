...
Common issues and solutions when using Spring Mouse.
...
1. **Auto-refresh (default):**
   Spring Mouse automatically refreshes tokens. Wait 30 seconds and retry.
...
**Problem:** "ECONNREFUSED" or "Cannot connect to localhost:8008".

**Causes:**
- Spring Mouse not running
- Port 8008 blocked
- Firewall blocking connection

**Solutions:**

1. **Start Spring Mouse:**
   ```bash
   spring-mouse
   ```
...
- Spring Mouse crashed
- Browser cache issues

**Solutions:**

1. **Check if Spring Mouse is running:**
   ```bash
   # Check process
