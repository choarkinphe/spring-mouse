...
Tích hợp Spring Mouse với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model Spring Mouse có sẵn:
...
### Connection Failed
- Xác minh Spring Mouse đang chạy: `curl http://localhost:8008/health`
