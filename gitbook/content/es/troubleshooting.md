...
Problemas comunes y soluciones al usar Spring Mouse.
...
1. **Refresh automático (por defecto):**
   Spring Mouse refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Problema:** "ECONNREFUSED" o "Cannot connect to localhost:8008".

**Causas:**
- Spring Mouse no está ejecutándose
- Puerto 8008 bloqueado
- Firewall bloqueando la conexión

**Soluciones:**

1. **Inicia Spring Mouse:**
   ```bash
   spring-mouse
   ```
   El dashboard debe abrir en http://localhost:3000

2. **Verifica el puerto 8008:**
   ```bash
...
- Spring Mouse crasheó
- Problemas de caché del navegador

**Soluciones:**

1. **Verifica si Spring Mouse está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep spring-mouse
