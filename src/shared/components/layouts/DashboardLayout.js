...
import ChatDebugWidget from "../ChatDebugWidget";
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-bg">
      ...
      <main className="flex flex-col flex-1 h-full min-w-0 relative transition-colors duration-300 isolate">
        ...
        <div className={`flex-1 min-h-0 custom-scrollbar ${(pathname?.startsWith("/dashboard/console-log") || pathname?.startsWith("/dashboard/chat-debug")) ? "overflow-hidden p-4 lg:p-6" : "overflow-y-auto p-4 lg:p-6"}`}>
          {pathname === "/dashboard" ? (
