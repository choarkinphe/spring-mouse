...
<div align="center">
  <img src="../images/spring-mouse.png?1" alt="แดชบอร์ด Spring Mouse" width="800"/>
  ...
  **ผู้ให้บริการ AI ฟรีสำหรับ OpenClaw**
  ...
  [🚀 เริ่มต้นใช้งาน](#-quick-start) • [💡 ฟีเจอร์](#-key-features) • [📖 การตั้งค่า](#-setup-guide) • [🌐 เว็บไซต์](https://spring-mouse.com)
</div>

---

## 🤔 ทำไมต้อง Spring Mouse?
...
🎉 เปิดแดชบอร์ดที่ `http://localhost:8008`
...
Repo นี้เป็น private package (`spring-mouse-app`) ดังนั้นการรันจากซอร์ส/Docker คือเส้นทางพัฒนาท้องถิ่นที่คาดไว้
...
URL ค่าเริ่มต้น:
- แดชบอร์ด: `http://localhost:8008/dashboard`
- OpenAI-compatible API: `http://localhost:8008/v1`

---

## 🛠️ เครื่องมือ CLI ที่รองรับ

Spring Mouse ทำงานได้อย่างราบรื่นกับเครื่องมือเขียนโค้ด AI ทุกประเภท:
...
Headroom เป็นตัวเลือกและทำงานแยกกัน Spring Mouse เรียก endpoint `/v1/compress` ของ Headroom จากนั้นยังคงเลือกเส้นทาง, fallback, auth และติดตามการใช้งานตามปกติ:
...
ถ้า Headroom ดับหรือคืน error, Spring Mouse จะ fail open และส่งคำขอต้นฉบับ
...
- เครื่องมือ CLI ของคุณส่งรูปแบบ OpenAI → Spring Mouse แปลง → ผู้ให้บริการได้รับรูปแบบต้นฉบับ
...
<details>
<summary><b>💳 Spring Mouse เก็บเงินฉันหรือไม่?</b></summary>

**ไม่.** Spring Mouse เป็นซอฟต์แวร์ฟรีแบบ open source ที่ทำงานบนเครื่องของคุณเอง มันไม่มีวันเรียกเก็บเงินจากคุณ

**คุณจ่ายเงินเฉพาะ:**
- ✅ **ผู้ให้บริการสมาชิก** (Claude Code $20/เดือน, Codex $20-200/เดือน) → จ่ายตรงให้พวกเขาบนเว็บไซต์ของพวกเขา
- ✅ **ผู้ให้บริการราคาถูก** (GLM, MiniMax) → จ่ายตรงให้พวกเขา, Spring Mouse แค่เลือกเส้นทางคำขอของคุณ
- ❌ **ตัว Spring Mouse เอง** → **ไม่มีวันเรียกเก็บเงินใดๆ ทั้งสิ้น**

Spring Mouse เป็น proxy/router ท้องถิ่น มันไม่มีบัตรเครดิตของคุณ, ไม่สามารถส่งใบแจ้งหนี้ได้ และไม่มีระบบชำระเงิน เป็นซอฟต์แวร์ฟรีทั้งหมด
...
Spring Mouse แค่เลือกเส้นทางคำขอของคุณไปหาพวกเขา — ไม่มี "กับดัก" หรือการเรียกเก็บเงินในอนาคต เป็นบริการที่ฟรีจริงๆ และ Spring Mouse ทำให้ใช้งานง่ายด้วยการรองรับ fallback
...
3. **ใช้ผู้ให้บริการสมาชิก** ก็ต่อเมื่อมีอยู่แล้ว:
   - Spring Mouse ช่วยเพิ่มประสิทธิภาพมูลค่าของพวกเขาผ่านการติดตามโควตา
...
**OAuth Token หมดอายุ**
- รีเฟรชอัตโนมัติโดย Spring Mouse
...
- ตั้ง `PORT=8008` และ `NEXT_PUBLIC_BASE_URL=http://localhost:8008`
...
- **เว็บไซต์**: [spring-mouse.com](https://spring-mouse.com)
...
ขอขอบคุณผู้มีส่วนร่วมทุกคนที่ช่วยทำให้ Spring Mouse ดียิ่งขึ้น!

[![Contributors](https://contrib.rocks/image?repo=decolua/spring-mouse&max=150&columns=15&anon=1)](https://github.com/decolua/spring-mouse/graphs/contributors)
