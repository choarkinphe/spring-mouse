<div align="center">
  <img src="../images/spring-mouse.png?1" alt="Painel do Spring Mouse" width="800"/>
  
  # Spring Mouse — roteador de IA GRATUITO e economizador de tokens
  ...
  **Conecte todas as ferramentas de código de IA (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) a mais de 40 provedores de IA e mais de 100 modelos.**
  ...
  [![Licença](https://img.shields.io/npm/l/spring-mouse.svg)](https://github.com/decolua/spring-mouse/blob/main/LICENSE)
...
[🚀 Início rápido](#-início-rápido) • [💡 Recursos](#-principais-recursos) • [📖 Configuração](#-guia-de-configuração) • [🌐 Site](https://spring-mouse.com)
...
└──────┬──────┘
       ...
       ↓
┌─────────────────────────────────────────────┐
│           Spring Mouse (Roteador inteligente)            │
...
🎉 O painel abre em `http://localhost:8008`
...
Este pacote de repositório é privado (`spring-mouse-app`), portanto, a execução pelo código-fonte/Docker é o caminho de desenvolvimento local esperado.
...
- Painel: `http://localhost:8008/dashboard`
- API compatível com OpenAI: `http://localhost:8008/v1`
...
<table>
  <tr>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw no Spring Mouse<br/>por <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>Spring Mouse + Claude Code Configuração ilimitada GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
      ...
      <b>🇺🇸 Inglês</b><br/>
      <sub>Spring Mouse + Claude Code Configuração GRATUITA<br/>por <a href="https://www.youtube.com/@BuildAIWithHamid">Construir IA com Hamid</a></sub>
    </td>
    <td align="center" width="320">
...
<img src="https://img.youtube.com/vi/Ttpc26m39Dw/maxresdefault.jpg" alt="Claude CLI Free Setup" width="300"/>
      ...
      <b>🇺🇸 Inglês</b><br/>
      Configuração gratuita <sub>Claude CLI com Spring Mouse 🚀<br/>por <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + Spring Mouse<br/>por <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
<td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
<sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Configuração Rápida Spring Mouse 🚀<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonésia</b><br/>
      <sub>Cara Implante Spring Mouse no Hugging Face GRATUITAMENTE sem parar! | Alternativa VPS RAM 16GB<br/>por <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="320">
<a href="https://www.youtube.com/watch?v=GyX-DLvePW8">
    ...
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=hPusYX-5Pmw">
        <img src="https://img.youtube.com/vi/hPusYX-5Pmw/maxresdefault.jpg" alt="Hướng Dẫn Setup OpenClaw + Spring Mouse: Tạo Bot Zalo AI Tự Động Từ A-Z" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + Spring Mouse: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>por <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
</td>
...
> 🎬 **Fez um vídeo sobre o Spring Mouse?** Envie um [Pull Request](https://github.com/decolua/spring-mouse/pulls) adicionando seu vídeo a esta seção - nós o mesclaremos!

---

## 🛠️ Ferramentas CLI suportadas

Spring Mouse funciona perfeitamente com todas as principais ferramentas de codificação de IA:
...
Configure `X-Spring Mouse-Token-Saver: off` para ignorar todos os economizadores de tokens para uma solicitação de chat.
...
O headroom é opcional e funciona separadamente. Spring Mouse chama o endpoint `/v1/compress` local do Headroom e, em seguida, mantém roteamento normal, fallback, autenticação e rastreamento de uso:

```
Cliente → Spring Mouse → Headroom /v1/compress → Spring Mouse → provedor
```
...
Se o Headroom estiver inativo ou retornar um erro, o o Spring Mouse seguirá em modo aberto e enviará a solicitação original.
...
- Sua ferramenta CLI envia formato OpenAI → Spring Mouse traduz → Provedor recebe formato nativo
...
> O próprio Spring Mouse **nunca cobra** nada. Você paga apenas aos provedores diretamente (se usar serviços pagos).
>
...
> roteamento através do Spring Mouse!
...
### 📊 Compreendendo os custos e faturamento do Spring Mouse

**Como funciona o faturamento do Spring Mouse:**

✅ **Software Spring Mouse = GRATUITO para sempre** (código aberto, nunca cobra)  
...
❌ **Spring Mouse nunca envia faturas** ou cobra seu cartão
...
- **Provedores baratos** (GLM, MiniMax): pague diretamente, Spring Mouse apenas roteia
- **Provedores GRATUITOS** (iFlow, Kiro, Qwen): Genuinamente grátis para sempre, sem taxas ocultas
- **Spring Mouse**: Nunca cobra nada
...
O painel rastreia o uso do token e exibe **custos estimados** como se você estivesse usando APIs pagas diretamente. Este **não é faturamento real** - é uma referência para mostrar quanto você está economizando usando modelos gratuitos ou assinaturas existentes através do Spring Mouse.
...
<details>
<summary><b>💳 Serei cobrado pelo Spring Mouse?</b></summary>

**Não.** Spring Mouse é um software gratuito e de código aberto que roda em seu próprio computador. Nunca cobra nada.

**Você só paga:**

- ✅ **Provedores de assinatura** (Claude Code $20/mo, Codex $20-200/mo) → Pague-os diretamente em seus sites
- ✅ **Provedores baratos** (GLM, MiniMax) → Pague diretamente, Spring Mouse apenas encaminha suas solicitações
- ❌ **Spring Mouse em si** → **Nunca carrega nada, nunca**

Spring Mouse é um proxy/roteador local. Não possui cartão de crédito, não pode enviar faturas e não possui sistema de cobrança. É um software totalmente gratuito.
...
O Spring Mouse apenas encaminha suas solicitações para eles - não há pegadinhas ou cobrança futura do próprio Spring Mouse. Eles são serviços verdadeiramente gratuitos e o Spring Mouse os torna fáceis de usar com suporte alternativo.
...
- Spring Mouse ajuda a maximizar seu valor por meio do rastreamento de cotas
...
O fallback inteligente do Spring Mouse evita cobranças surpresa:
...
**Você está no controle:** Defina limites de gastos por provedor no painel e o Spring Mouse os respeita.
...
**Dica profissional:** Use o Opus para tarefas complexas e o Sonnet para velocidade. Spring Mouse rastreia cota por modelo!
...
Configurações → Modelos → Avançado:
  ...
  OpenAI API Key: [copie do painel do Spring Mouse]
...
> **Nota:** OpenClaw só funciona com Spring Mouse local. Use `127.0.0.1` em vez de `localhost` para evitar problemas de resolução IPv6.
...
- Hub Docker: [`decolua/spring-mouse`](https://hub.docker.com/r/decolua/spring-mouse)
...
docker pull decolua/spring-mouse:latest   # atualizar para a versão mais recente
```

**Persistência de dados:** `$HOME/.spring-mouse/db/data.sqlite` no host ↔ `/app/data/db/data.sqlite` no contêiner.

### Variáveis de Ambiente

| Variável | Padrão | Descrição |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET` | Gerado automaticamente (`~/.spring-mouse/jwt-secret`) | Segredo de assinatura JWT para cookie de autenticação do painel (substituir para compartilhar entre instâncias) |
| `INITIAL_PASSWORD` | `123456` | Primeira senha de login quando não existe hash salvo |
| `DATA_DIR` | `~/.spring-mouse` | Localização principal dos dados do aplicativo (SQLite em `$DATA_DIR/db/data.sqlite`) |
| `PORT` | padrão da estrutura | Porta de serviço (`8008` nos exemplos) |
...
| `BASE_URL` | `http://localhost:8008` | URL base interna do lado do servidor usada por trabalhos de sincronização na nuvem |
| `CLOUD_URL` | `https://spring-mouse.com` | URL base do endpoint de sincronização na nuvem do lado do servidor |
...
- Atualizado automaticamente pelo Spring Mouse
...
- Definir `PORT=8008` e `NEXT_PUBLIC_BASE_URL=http://localhost:8008`
...
- **Site**: [spring-mouse.com](https://spring-mouse.com)
...
Obrigado a todos os colaboradores que ajudaram a tornar o Spring Mouse melhor!

[![Contribuidores](https://contrib.rocks/image?repo=decolua/spring-mouse&max=150&columns=15&anon=1&v=20260309)](https://github.com/decolua/spring-mouse/graphs/contributors)

---

## 📊 Gráfico de estrelas

[![Gráfico de estrelas](https://starchart.cc/decolua/spring-mouse.svg?variant=adaptive)](https://starchart.cc/decolua/spring-mouse)
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Economizador de tokens em Rust. O Spring Mouse porta seu pipeline de compactação para JS → **−20-40% de tokens de entrada** em cada solicitação.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) por **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"por que usar muitos tokens quando poucos tokens resolvem"_. Spring Mouse adapta seu prompt → **−65% tokens de saída**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Estrelas](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) por **[@DietrichGebert](https://github.com/DietrichGebert)** — _"desenvolvedor sênior preguiçoso"_ habilidade. Spring Mouse injeta sua abordagem YAGNI-first → **menos tokens, menos código, diferenças mais curtas**.

Um grande agradecimento a esses autores – sem o trabalho deles, os recursos de economia de tokens do Spring Mouse não existiriam. Dê uma ⭐ a eles no GitHub!
