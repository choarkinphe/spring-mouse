...
Spring Mouse es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

Spring Mouse proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a Spring Mouse usando estas configuraciones:

**Spring Mouse local:**
```
Base URL: http://localhost:8008/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Spring Mouse (cc/*, cx/*, glm/*, etc.)
```

**Spring Mouse en la nube:**
```
Base URL: https://spring-mouse.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Spring Mouse (cc/*, cx/*, glm/*, etc.)
```
...
ROUTER_BASE_URL=http://localhost:8008/v1
...
**Problema:** No se puede conectar a Spring Mouse
```bash
# Verifica si Spring Mouse está corriendo
...
**Solución:**
- Verifica que Spring Mouse esté corriendo
- Verifica que el puerto 8008 no esté bloqueado
...
- Verifica los modelos disponibles: `curl http://localhost:8008/v1/models`
...
- Verifica la conexión de red a Spring Mouse
