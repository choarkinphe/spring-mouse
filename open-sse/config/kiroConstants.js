 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what spring-mouse needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a spring-mouse
 ...
 * The suffix is a spring-mouse request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a spring-mouse synthetic agentic variant.
...
/**
 * Detect whether a model id is a spring-mouse synthetic thinking variant
...
/**
 * Resolve a spring-mouse model id to the real upstream Kiro model id, plus flags
