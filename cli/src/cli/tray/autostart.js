...
const APP_LABEL = "com.spring-mouse.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when spring-mouse is currently
 ...
 * SIGTERM to the running process. When the running spring-mouse cli.js was itself
...
<dict>
    ...
    <string>/tmp/spring-mouse.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/spring-mouse.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `spring-mouse.cmd` lookup that depended on the npm prefix path.
...
Type=Application
Name=Spring Mouse
Comment=Spring Mouse API Proxy
