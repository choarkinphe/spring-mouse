...
Common questions about Spring Mouse.

---

## What is Spring Mouse?

**Spring Mouse is an AI model router that maximizes your subscription value and minimizes costs.**
...
**Spring Mouse uses a 3-tier pricing strategy:**
...
## Is Spring Mouse free?

**Yes, Spring Mouse itself is 100% free and open source.**
...
**Yes! This is Spring Mouse's core feature.**
...
**Spring Mouse tracks quota in real-time for all providers:**
...
## Can I self-host Spring Mouse?

**Yes! Spring Mouse supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.spring-mouse`)
...
**Yes, Spring Mouse prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.spring-mouse` (or custom `DATA_DIR`)
- No data sent to Spring Mouse servers
...
**What Spring Mouse stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What Spring Mouse does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/decolua/spring-mouse/blob/main/CHANGELOG.md)
- Backup `~/.spring-mouse` before major updates
...
See [CONTRIBUTING.md](https://github.com/decolua/spring-mouse/blob/main/CONTRIBUTING.md) for details.
